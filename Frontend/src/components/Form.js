...
const Form = () => {
    ...
    return (<>
        <form>
            ...
            {isUpdate == false ?
                <button type="submit" className="btn btn-primary mx-3" onClick={addNote}>
                    Add Note
                </button> :
                <button type="submit" className="btn btn-primary mx-3" onClick={handleEdit}>
                    update
                </button>}
